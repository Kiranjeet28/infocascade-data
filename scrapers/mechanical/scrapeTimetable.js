...
const OUTPUT_PATH = path.join(__dirname, '../../../info-data/data/web/timetable_mechanical.json');
const GROUP_LIST_PATH = path.join(__dirname, '../../../info-data/data/web/group/mechanical.json');
const TIMETABLE_PATH = path.join(__dirname, '../../../info-data/data/public/timetable_mechanical.json');
const TIME_SLOTS = [
